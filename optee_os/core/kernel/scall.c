...
static const struct syscall_entry tee_syscall_table[] = {
	...
	SYSCALL_ENTRY(syscall_vfs_open),
	SYSCALL_ENTRY(syscall_vfs_close),
	SYSCALL_ENTRY(syscall_vfs_access),
	SYSCALL_ENTRY(syscall_vfs_getcwd),
	SYSCALL_ENTRY(syscall_vfs_stat),
	SYSCALL_ENTRY(syscall_vfs_write),
	SYSCALL_ENTRY(syscall_vfs_mkdir),
	SYSCALL_ENTRY(syscall_vfs_rmdir),
	SYSCALL_ENTRY(syscall_vfs_unlink),
	SYSCALL_ENTRY(syscall_vfs_ftruncate),
	SYSCALL_ENTRY(syscall_vfs_read),
	SYSCALL_ENTRY(syscall_vfs_fchmod),
	SYSCALL_ENTRY(syscall_vfs_fchown),
	SYSCALL_ENTRY(syscall_vfs_geteuid),
	SYSCALL_ENTRY(syscall_vfs_getpid),
	SYSCALL_ENTRY(syscall_vfs_getenv),
	SYSCALL_ENTRY(syscall_vfs_lseek),
	SYSCALL_ENTRY(syscall_vfs_fsync),
	SYSCALL_ENTRY(syscall_vfs_sleep),
	SYSCALL_ENTRY(syscall_vfs_pread),
	SYSCALL_ENTRY(syscall_vfs_pwrite),
	SYSCALL_ENTRY(syscall_vfs_truncate),
	SYSCALL_ENTRY(syscall_vfs_gettimeofday),
	SYSCALL_ENTRY(syscall_vfs_fstat),
	SYSCALL_ENTRY(syscall_vfs_fcntl_void),
	SYSCALL_ENTRY(syscall_vfs_fcntl_int),
	SYSCALL_ENTRY(syscall_vfs_fcntl_flock),
	SYSCALL_ENTRY(syscall_vfs_utimes),
	SYSCALL_ENTRY(syscall_vfs_time),
	SYSCALL_ENTRY(syscall_vfs_usleep),
	SYSCALL_ENTRY(syscall_vfs_filesize)
};
